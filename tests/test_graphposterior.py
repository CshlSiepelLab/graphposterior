...
import os
import numpy as np
from graphposterior.core import BeamResults
from graphposterior import data_loader
import pandas as pd
import dendropy
import random
...
def test_plot_thresholded_graph_single_edge(beam_results, tmp_path):
    ...
    from graphposterior.plotting import plot_thresholded_graph
...
def test_process_tree_for_consensus(beam_results):
    ...
    from graphposterior.posterior_processing import _process_tree_for_consensus
...
def test_process_tree_wrapper(beam_results):
    ...
    from graphposterior.posterior_processing import _process_tree_wrapper
...
def test_sample_trees_with_output(beam_results, tmp_path):
    ...
    from graphposterior.posterior_processing import sample_trees
...
def test_get_all_posterior_metastasis_times_with_output(beam_results, tmp_path):
    ...
    from graphposterior.posterior_processing import get_all_posterior_metastasis_times
...
def test_get_consensus_graph_invalid_input(beam_results):
    ...
    from graphposterior.posterior_processing import get_consensus_graph
